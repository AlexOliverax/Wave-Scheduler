...
TRANSLATIONS = {
    "pt-BR": {
        ...
        "wave_frequency": "Frequência da Wave:",
        "frequency_daily": "Diária (por dia)",
        "frequency_weekly": "Semanal (por semana)",
        ...
        "file_label": "Arquivo:",
        "outlook_success": "Eventos adicionados ao Outlook! (Arquivo .ics aberto — confirme a importação no Outlook)",
        "outlook_failed": "Não foi possível criar os eventos no Outlook. Verifique o log.",
    ...
    "en-US": {
        ...
        "frequency_daily": "Daily (by day)",
        "frequency_weekly": "Weekly (by week)",
        ...
        "file_label": "File:",
        "outlook_success": "Events added to Outlook! (.ics file opened — confirm import in Outlook)",
        "outlook_failed": "Could not create events in Outlook. Check the log.",
    ...
    "es-US": {
        ...
        "wave_frequency": "Frecuencia de Ondas:",
        "frequency_daily": "Diaria (por día)",
        "frequency_weekly": "Semanal (por semana)",
        ...
        "file_label": "Archivo:",
        "outlook_success": "¡Eventos añadidos a Outlook! (Archivo .ics abierto — confirme la importación en Outlook)",
        "outlook_failed": "No se pudieron crear los eventos en Outlook. Verifique el registro.",
    ...
    "fr-FR": {
        ...
        "wave_frequency": "Fréquence des Waves:",
        "frequency_daily": "Quotidienne (par jour)",
        "frequency_weekly": "Hebdomadaire (par semaine)",
        ...
        "file_label": "Fichier:",
        "outlook_success": "Événements ajoutés à Outlook ! (Fichier .ics ouvert — confirmez l'importation dans Outlook)",
        "outlook_failed": "Impossible de créer les événements dans Outlook. Vérifiez le journal.",
    ...
    "de-DE": {
        ...
        "wave_frequency": "Wave-Frequenz:",
        "frequency_daily": "Täglich (pro Tag)",
        "frequency_weekly": "Wöchentlich (pro Woche)",
        ...
        "file_label": "Datei:",
        "outlook_success": "Ereignisse zu Outlook hinzugefügt! (.ics-Datei geöffnet — Import in Outlook bestätigen)",
        "outlook_failed": "Outlook-Ereignisse konnten nicht erstellt werden. Protokoll prüfen.",
